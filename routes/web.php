...
Route::get('/wishlist/create/{pro_id}', 'WishlistController@create')->name('wishlist.product.create')->middleware('auth');
Route::get('/wishlist', 'WishlistController@index')->name('wishlist.product.view')->middleware('auth');
Route::get('/wishlist/cart_create', 'WishlistController@cart_create')->name('wishlist.cart_create')->middleware('auth');
Route::delete('/wishlist/remove/{id}', 'WishlistController@remove')->name('wishlist.product.remove')->middleware('auth');
